...
(async () => {
    ...
    await page.pdf({ path: "./test-pdfs/TestCaseThreeSLO1.pdf", format: "A4" })
    {
        const targetPage = page;
        await scrollIntoViewIfNeeded([
            [
    ...
    }
    {
        ...
        const inputType = await element.evaluate(el => el.type);
        if (inputType === 'select-one') {
          await changeSelectElement(element, 'Students will understand Agile Processes')
        } else if ([
            'textarea',
            'text',
            'url',
          ...
          await typeIntoElement(element, 'Students will understand Agile Processes');
        } else {
          await changeElementValue(element, 'Students will understand Agile Processes');
        }
    }
    {
        const targetPage = page;
    ...
    }
    {
        ...
        const inputType = await element.evaluate(el => el.type);
        if (inputType === 'select-one') {
          await changeSelectElement(element, 'Ensure students are emulating a fast paced enviornment')
        } else if ([
            'textarea',
            'text',
            'url',
          ...
          await typeIntoElement(element, 'Ensure students are emulating a fast paced enviornment');
        } else {
          await changeElementValue(element, 'Ensure students are emulating a fast paced enviornment');
        }
    }
    {
        const targetPage = page;
    ...
    }
    {
        ...
        const inputType = await element.evaluate(el => el.type);
        if (inputType === 'select-one') {
          await changeSelectElement(element, 'Sample of Students - Describe below')
        } else if ([
            'textarea',
            'text',
            'url',
          ...
          await typeIntoElement(element, 'Sample of Students - Describe below');
        } else {
          await changeElementValue(element, 'Sample of Students - Describe below');
        }
    }
    {
        const targetPage = page;
    ...
    await page.screenshot({ path: "./test-pdfs/test-screenshots/TestCaseThreeSLO2Data1.png"})
    {
        const targetPage = page;
        await scrollIntoViewIfNeeded([
            [
    ...
    await page.pdf({ path: "./test-pdfs/TestCaseThreeSLO2Measure1.pdf", format: "A4" })
    {
        const targetPage = page;
        await scrollIntoViewIfNeeded([
            [
    ...
    }
    {
        ...
        const inputType = await element.evaluate(el => el.type);
        if (inputType === 'select-one') {
          await changeSelectElement(element, 'Task creation and completion rate')
        } else if ([
            'textarea',
            'text',
            'url',
          ...
          await typeIntoElement(element, 'Task creation and completion rate');
        } else {
          await changeElementValue(element, 'Task creation and completion rate');
        }
    }
    {
        const targetPage = page;
    ...
    }
    {
        ...
        const inputType = await element.evaluate(el => el.type);
        if (inputType === 'select-one') {
          await changeSelectElement(element, 'Encourages high throughput of tasks')
        } else if ([
            'textarea',
            'text',
            'url',
          ...
          await typeIntoElement(element, 'Encourages high throughput of tasks');
        } else {
          await changeElementValue(element, 'Encourages high throughput of tasks');
        }
    }
    {
        const targetPage = page;
    ...
    }
    {
        ...
        const inputType = await element.evaluate(el => el.type);
        if (inputType === 'select-one') {
          await changeSelectElement(element, 'Need to validate the number of measures and ensure they are enforced.')
        } else if ([
            'textarea',
            'text',
            'url',
          ...
          await typeIntoElement(element, 'Need to validate the number of measures and ensure they are enforced.');
        } else {
          await changeElementValue(element, 'Need to validate the number of measures and ensure they are enforced.');
        }
    }
    {
        const targetPage = page;
    ...
    }
    {
        ...
        const inputType = await element.evaluate(el => el.type);
        if (inputType === 'select-one') {
          await changeSelectElement(element, 'No stakeholder information.')
        } else if ([
            'textarea',
            'text',
            'url',
